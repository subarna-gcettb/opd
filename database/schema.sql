...
--
-- NOTE: this file is the v1 BASELINE (mirrored as migrations/001), per
-- the patch-friendly rule in PATCHING.md an already-shipped migration
-- is never edited in place. For the true current schema, apply this
-- plus every file in database/migrations/ in order (`node database/
-- migrate.js` does this automatically and is safe to re-run).
-- =====================================================================
